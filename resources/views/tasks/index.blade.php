...
<h1>Add Task!</h1>
        <div>
            ...
            <x-text-input id="summary" class="block mt-1 w-full" type="text" name="summary" :value="old('summary')" required autofocus autocomplete="summary" />
...
<p class="mt-4 text-lg text-red-900">{{ $task->summary }}</p>

<p class="mt-4 text-sm text-gray-900">{{ $task->description }}</p>
</div>
